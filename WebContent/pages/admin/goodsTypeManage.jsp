...
<script type="text/javascript">
	...
	function openGoodsTypeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加货物类别");
	...
	function openGoodsTypeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑货物类别信息");
		$("#id").val(row.id);
...
<body>
	...
	<table style="height:423px; width:1160px;" id="dg" title="货物管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/stockManageSystem/goodsType" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="typeName" width="15">货物类别名称</th>
				<th field="typeDesc" width="25">货物类别备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;货物类别名称：&nbsp;<input type="text" name="s_typeName" id="s_typeName"/><a href="javascript:searchGoodsType()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
