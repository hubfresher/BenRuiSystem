...
<body style="margin: 5px;">
	<table style="height:423px; width:1160px" id="dg" title="客户管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/stockManageSystem/provider" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="proId" width="15">客户编号</th>
				<th field="proName" width="25">客户名称</th>
				<th field="linkman" width="25">联系人</th>
				<th field="proPhone" width="25">联系电话</th>
				<th field="proDesc" width="100">客户备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;客户名称：&nbsp;<input type="text" name="s_proName" id="s_proName"/><a href="javascript:searchProvider()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
